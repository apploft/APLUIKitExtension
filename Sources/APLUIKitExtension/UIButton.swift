...
public extension UIButton {
    ...
    /// - Parameter color: the color to set
    /// - Parameter forState: the state to set the color for
    @objc func setRoundedRectBackgroundImage(color: UIColor, height: CGFloat, cornerRadius: CGFloat, forState: UIControl.State) {
    ...
    /// - Parameter forState: the state to set the color for
    @objc func setGradientBackgroundColor(startColor: UIColor, endColor: UIColor, forState: UIControl.State) {
